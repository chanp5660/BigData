...
- 게임머니로 아이템을 구매하기에는 **아이템의 가치**가 너무 높아 **현금**으로 거래가 필요했고 그 **거래를 중개**해주는 사이트가 생겨나게 되었다. 사이트는 중개를 통한 거래 **안전성**을 **대가**로 판매금액의 일정금액을 **수수료**로 취한다.
...
3. **판매하는 방법**에서 분류를 하므로 어느 정도까지 분류 되어있는지 찾아본다. [밑에 참조](https://bit.ly/2vIk2oZ)
