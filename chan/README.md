...
### 이용건수
비인기 게임 한개의 서버에서 7시간 정도 평균 400개 정도의 판매공고가 올라온다.
이후 모든 게임 모든 서버의 하루 이용건수를 구해 추가정보를 넣을 예정

문제 발생 : 위의 판매등록 방법에서 보면 유로서비스로 재등록 해주는 서비스가 있는데 똑같은 사람이 재등록해서 올라온 판매공고를 중복제거해야하는지 인정해야 하는지 구분지어야 함.
